...
public final class AhfClientEvents {
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        while (AhfKeybinds.TOGGLE_HITBOX.consumeClick()) {
            ...
            mc.player.sendOverlayMessage(Component.literal("Hitbox overlay: "
                    + (HitboxDebugRenderer.enabled ? "on (" + HitboxDebugRenderer.style + ", scroll to change)" : "off")));
        }
    }
    ...
    public static void onMouseScroll(InputEvent.MouseScrollingEvent event) {
        ...
        mc.player.sendOverlayMessage(Component.literal("Hitbox overlay: " + now));
